<template>
	<view class="ts-column ts-flex-item">
				...
				<view class="section-content">
					<view class="ts-column ts-flex-item">
						<view class="ts-column ts-center">
							<!-- <image style="width: 200upx; height: 200upx; border-radius: 200upx;" :src="detail.cover_image"></image> -->
		...
		<view class="ts-column">
			<ts-load-more :loadingType="loadingType" :contentText="contentText" @tap="loadMoreSearchResult"></ts-load-more>
		</view>
	</view>
</template>
